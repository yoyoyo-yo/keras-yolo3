...
def _main():
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='model_data_my/tiny_yolo_weights.h5')
    else:
    ...
    val = np.random.choice(lines, num_val, replace=False)
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='model_data_my/yolo_weights.h5'):
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='model_data_my/tiny_yolo_weights.h5'):
